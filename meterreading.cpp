...
QString MeterReading::getResourceType() const { return resource_type_; }
QDate MeterReading::getDate() const { return date_; }
double MeterReading::getValue() const { return value_; }

void MeterReading::setResourceType(const QString& resourceType) { resource_type_ = resourceType; }
void MeterReading::setDate(const QDate& date) { date_ = date; }
void MeterReading::setValue(double value) { value_ = value; }
